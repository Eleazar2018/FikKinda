...
public class Alterar extends JFrame {
	...
	public Alterar() {
		...
		btnConfirma.setIcon(new ImageIcon(Alterar.class.getResource("/Imagens/adicionar.png")));
		...
		btnConfirma.setBounds(44, 377, 148, 33);
		contentPane.add(btnConfirma);
		
		btnLimpa = new JButton("Limpar");
		btnLimpa.setIcon(new ImageIcon(Alterar.class.getResource("/Imagens/bin.png")));
		...
		btnCancela.setIcon(new ImageIcon(Alterar.class.getResource("/Imagens/botao-cancelar.png")));
		...
		btnProcura.setIcon(new ImageIcon(Alterar.class.getResource("/Imagens/pesquisa.png")));
